...
FIRST_CREATED = Column('FIRST INSTANCE', 25, lambda s: format_dt_local_tz(s.first_created, include_ms=False), stats_style)
LAST_CREATED = Column('LAST INSTANCE', 25, lambda s: format_dt_local_tz(s.last_created, include_ms=False), stats_style)
...
DEFAULT_COLUMNS =\
    [JOB_ID, ENDED, FIRST_CREATED, LAST_CREATED, AVERAGE, SLOWEST, LAST_TIME, STATE, FAULTS, WARN]
