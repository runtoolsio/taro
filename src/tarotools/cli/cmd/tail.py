...
from tarotools.taro.jobs.criteria import compound_id_filter, InstanceCriteria
...
def run(args):
    ...
    if args.follow:
        ...
        for tail_resp in taro.client.read_tail(InstanceCriteria(id_criteria)).responses:
