...
from tarotools.taro.jobs.criteria import compound_id_filter, JobInstanceAggregatedCriteria
...
def run(args):
    ...
    if args.follow:
        ...
        for tail_resp in taro.client.read_tail(JobInstanceAggregatedCriteria(id_criteria)).responses:
