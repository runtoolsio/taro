...
from tarotools.taro.jobs.criteria import JobInstanceAggregatedCriteria
...
def run(args):
    ...
    for instance in args.instances:
        instance_match = JobInstanceAggregatedCriteria.parse_pattern(instance, MatchingStrategy.FN_MATCH)
